...
\begin{table}
	...
	\cline{1-4}
	\multirow{8}{*}[-5em]{Video}       & \multirow{2}{*}[-2em]{Mono}                                                                & \multirow{2}{*}{2D}    & \begin{tabular}[c]{@{}l@{}}+ Very robust in all contexts\\+ Cheap and easy to setup\\- Only 2D\\- Not very accurate\end{tabular}  \\ 
	\cline{3-4}							 
