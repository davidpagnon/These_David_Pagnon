...
The objective of this thesis is to participate in building a bridge between the fields of computer vision and biomechanics in a sports context, by providing methods for robust, accurate, and versatile markerless kinematics. Nevertheless, the adoption of markerless analysis by the community will be determined by its ease of use. Consequently, we built a simple and open-source pipeline connecting the two aforementioned state-of-the-art tools: OpenPose and OpenSim. Robustness and accuracy will be assessed, and concrete applications will be discussed, such as the use of GoPro cameras for assessing key performance indicators in boxing, and the joint kinematic analysis of bike and pilot in BMX racing.
...
% \begin{textblock*}{5cm}(10cm,5cm) % {block width} (coords) 
% 	\begin{turn}{45} 
