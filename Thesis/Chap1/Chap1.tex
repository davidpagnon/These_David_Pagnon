...
All of the tools presented in this section are open-source. See Chapter 2.1.3 on \nameref{sec:Machine learning for 2D pose detection} for more technical details.
...
\begin{table}
	...
	\midrule
	\multirow{5}{*}{RGB-D}       & Mono                                                                                 & 2.5D                   & \begin{tabular}[c]{@{}l@{}}+ Markerless\\- Generally poor accuracy\\- Frame-rate $\leq$ 30 Hz\\- Needs distance $\leq$ 5m and no direct sunlight\end{tabular}  \\ 
	\cline{2-4}
								 & Multi                                                                                & 3D                     & \begin{tabular}[c]{@{}l@{}}+ Full 3D markerless\\+ Better accuracy\\- Same as above re. frame-rate, distance, and light\end{tabular}  \\ 
	\cline{1-4}
	\multirow{8}{*}[-5em]{RGB video}       & \multirow{2}{*}[-2em]{Mono}                                                                & \multirow{2}{*}{2D}    & \begin{tabular}[c]{@{}l@{}}+ Very robust in all contexts\\+ Cheap and easy to setup\\- Only 2D\\- Not very accurate\end{tabular}  \\ 
	\cline{3-4}							 
