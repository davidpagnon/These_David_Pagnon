...
\begin{table}
	...
	\midrule
	\multirow{5}{*}{Depth}       & Mono                                                                                 & 2.5D                   & \begin{tabular}[c]{@{}l@{}}+ Markerless\\- Generally poor accuracy\\- Frame-rate $\leq$ 30 Hz\\- Needs distance $\leq$ 5m and no direct sunlight\end{tabular}  \\ 
	\cline{2-4}
								 & Multi                                                                                & 3D                     & \begin{tabular}[c]{@{}l@{}}+ Full 3D markerless\\+ Better accuracy\\- Same as above re. frame-rate, distance, and light\end{tabular}  \\ 
	\cline{1-4}
	\multirow{8}{*}[-5em]{Video}       & \multirow{2}{*}[-2em]{Mono}                                                                & \multirow{2}{*}{2D}    & \begin{tabular}[c]{@{}l@{}}+ Very robust in all contexts\\+ Cheap and easy to setup\\- Not very accurate\\- Rather slow\end{tabular}  \\ 
	\cline{3-4}							 
	...
	\cline{1-4}
	Sensor fusion                & N/A                                                                                  & 3D                     & \begin{tabular}[c]{@{}l@{}}With IMUs: More accuracte, but not markerless\\With one RGB-D cameras, OpenPose and depth \\information: still inaccurate\end{tabular}                                                                     \\
	\bottomrule
	\end{tabular}
	\caption{Pros and cons in state of the art approaches for human motion analysis. Multi-person is not addressed, as it can be available or not with all approaches depending on the specific solution. IMU: Inertial Measurement Unit. N/A: Not Applicable. kin.: kinematic}
	\label{tab_stateart}
\end{table}
