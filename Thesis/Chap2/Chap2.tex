...
\begin{figure}[hbtp]
	...
	\caption{The 3D reconstructed point is approximated as the minimal distance between epipolar lines, which pass by the camera centers and the 2D detected points.}
...
assumes that markers are positionned very accurately, by one single trained operator.
