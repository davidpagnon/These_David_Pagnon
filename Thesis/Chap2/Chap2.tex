...
calibre toutes les caméras ensemble (plus général, mais plus dur à optimiser: heureusement, Jacobien creux), 
Besoin de calibration initiale, avec L frame par exemple . 
Extrinsic utilise toutes les frames, plutôt calculée pour chaque frame (pas besoin d'une frame avec toutes les caméras qui voient le checkerboard.
