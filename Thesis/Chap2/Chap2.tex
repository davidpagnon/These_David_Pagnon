...
initially for robotics (simple), 3D animation applications (visually plausible rather than accurate) until models and scaling became more thoroughly defined and trustworthy
