...
specific simple problems, 
attacked commen-sense issues with massive databases 
and massive funding programs such as the Japanese Fifth Generation Computer project, aiming to build a supercomputer that could solve any problem.

% Adaline (gradient descent)
% Logistic regression (softmax)
% Multi-layer (backpropagation)
% Neats (basic principles extended to general intelligence) vs scruffies (specific solutions for each problem)
