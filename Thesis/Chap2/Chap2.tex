...
- Calibre toutes les caméras ensemble: 1. calculs intenses, heureusement, Jacobien creux. 2. Besoin d'initialisation solide (plus général, plus de variables à optimiser), avec L frame par exemple pour calib initiale, ou matrice intrinsèque précalculée. 
