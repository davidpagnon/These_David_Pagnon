...
Jacobian: if biomechanical laws and weighted constraints; heuristic: needs to be fast; hessian/second derivatives (slow); quasi-Newton; data driven; avec prise en comptes de forces /RRA ?
