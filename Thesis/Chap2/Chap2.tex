...
2 méthodes: algorithme de Levenberg-Marquardt avec calcul du Jacobien pseudo-inverse, et optimisation sequentielle quadratique
...
kineticstoolkit (6DoF ISB), pyCGM2 (6DoF gait), pyomeca (opensim, biorbd), custom (jacobien et optim sqp), pinocchio (Jacobian), OpenSim (sqp?)
Vicon, QTM (Visual3D)
