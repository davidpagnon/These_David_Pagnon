...
% - Résultats similaires à checkerboard, millimetric
% - Much less cumbersome (transportation). 
% - Plus simple: Utilisée par quasi toutes les solutions commerciales + easywand + argus (free but not open-source), but 2 steps
...
% - pas dispo sous OpenCV ni SciPy, pas de bonne bibliothèque open-source sba sous python.
% - Moins bien pour distorsion
% - 2 markers durs à différencier de l'arrière plan, contrairement à motif complexe comme checkerboard (mais checkerboard pas détectable dans certains angles,et pour extrinsèque devrait être grand)
