...
It would also be useful to support multi-person analysis, to have a more accurate and extensive 2D pose estimator, to work in real time, and to provide a GUI. All these considerations are discussed in the \nameref{ch3_lim} section of the previous chapter on the \hyperref[ch:3]{Pose2Sim package}.
