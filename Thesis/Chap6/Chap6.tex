...
When fine kinematic analysis is needed, the de facto approach is marker-based motion capture. However, it is not appropriate in sports, and markerless methods are favored.
