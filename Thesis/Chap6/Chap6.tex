...
\begin{table}[!ht]
      ...
      \begin{tabular}{lllll}
          ...
          \cmidrule(l{2pt}r{2pt}){2-5}
          Lead foot translation (cm) & 0.85 & 2.05 & 0.95 & 3.46\\
          Pelvis translation (cm) & 0.79 & 0.83 & 0.83 & 1.56\\
...
\begin{table}[!ht]
      ...
      \begin{tabular}{lcccc}
          ...
          \cmidrule(l{2pt}r{2pt}){2-5}
          \raggedleft Lead foot translation\(^1\) (cm) & -1.06 ($\pm$0.67) * & -1.00 ($\pm$0.74) * & -0.11 ($\pm$0.98) & 0.49 ($\pm$1.20) \\
          \raggedleft{Pelvis translation\(^1\) (cm)} & -0.69 ($\pm$0.60) * & 0.43 ($\pm$0.53) * & -0.41 ($\pm$0.74) & 1.12 ($\pm$0.95) * \\
...
\begin{table}[!ht]
      ...
      \begin{tabular}{lcccc}
            ...
            \shortstack{\(\mathbf{Mean_{err}}\) \textbf{($\pm$std)} \\~} & \shortstack{\textbf{ROM\(^1\) \emph{or} Peak value}\\(cm, °, or m/s)} & \shortstack{\textbf{Onset\(^1\) \emph{or} Peak time}\\(ms)} & \shortstack{\textbf{ROM\(^1\) \emph{or} Peak value} \\(cm, °, or m/s)} & \shortstack{\textbf{Onset\(^1\) \emph{or} Peak time}\\(ms)} \\
            \cmidrule(l{2pt}r{2pt}){2-2} \cmidrule(l{2pt}r{2pt}){3-3}
            \cmidrule(l{2pt}r{2pt}){4-4} \cmidrule(l{2pt}r{2pt}){5-5}
            \textbf{Jab}\\
            Lead foot translation\(^1\) & 0.33 ($\pm$0.89) * & -23.1 ($\pm$18.9) * & 1.22 ($\pm$1.09) * & -10.2 ($\pm$16.1) *\\
            Pelvis translation\(^1\) & 1.33 ($\pm$1.04) * & -18.1 ($\pm$18.4) * & 0.48 ($\pm$0.82) * &-3.2 ($\pm$15.8) \\
