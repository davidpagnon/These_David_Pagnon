...
No clear conclusion could be drawn from tests of significance. KPI results were more often significantly different for the jab than for the hook punches, and for magnitudes than for times. 

As differences were never normally distributed, paired t-tests could not be rigorously performed. As a consequence, we only used Wilcoxon signed-rank tests. However, in many cases, especially for time results, most paired differences were equal to zero. In these cases, we could not reject the null hypothesis that results were identical in average. 

no apparent peak could be found on hook trials for subject 2 on rear knee flexion nor on rear shoulder abduction. Hence, mean and standard deviation were only computed for the other 2 subjects.

COMPARER MAINTENANT LES MOYENNES

% Peak values and times were not always as accurate, as curves were subject to more noise with the use of the standard model. (MEAN DIFF and STD AVERAGED AMONG VARIABLES for each protocol). In particular, and especially with the standard body\_25 model, fist velocities were less accurate, as well as upper-body joint angles. Elbow extension was underestimated. Conversely, the ranges of motion measured for the translations of the lead foot and of the pelvis were not significantly different from marker-based results, regardless of the protocol. Similar accurate outcome was observed with times of inflection points. (DETAILLER DIFF SIGNIF?)
...
% Time differences were mostly statistically significant when GoPros were used

% 


However, we could still compare the average magnitude of differences between marker-based results and other protocol results, and the average impact of camera types and 2D pose estimation models.
...
\begin{table}[!ht]
      ...
      \begin{tabular}{lcccc}
            ...
            Rear shoulder rotaion\(^2\) & 2.0 ($\pm$5.2) * & 29.9 ($\pm$80.6) & 1.2 ($\pm$4.6) & 13.2 ($\pm$68.9) \\
