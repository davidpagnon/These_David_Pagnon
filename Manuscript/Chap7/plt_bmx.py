...
ax[0,1].set_xlabel('Time (s)', fontweight="bold")
...
ax[0,2].set_xlabel('Time (s)', fontweight="bold")
...
ax[2,2].set_ylabel('Segment excursion X (m)', fontweight="bold")
ax[2,2].set_xlabel('Segment excursion X (m)', fontweight="bold")
